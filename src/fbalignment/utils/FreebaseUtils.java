...
public class FreebaseUtils {
  ...
  public final static Pattern DELIMITER_PATTERN = Pattern.compile("\t");
  public final static String NAME_PROPERTY = "/type/object/name";
  public final static String ALIAS_PROPERTY = "/common/topic/alias";
  public final static String TYPE_PROPERTY = "/type/object/type";
  public final static String PROFESSION_PROPERTY = "/people/person/profession";
  public final static String MID_PREFIX = "/m/";
  public final static String COMMON_DOMAIN_PREFIX = "/common/";
  public final static String USER_DOMAIN_PREFIX = "/user/";
  public final static String BASE_DOMAIN_PREFIX = "/base/";
  public final static String FREEBASE_DOMAIN_PREFIX = "/freebase/";
  public final static String DATA_DOMAIN_PREFIX = "/dataworld/";
  public final static String TYPE_DOMAIN_PREFIX = "/type/";
  // indices in data dump file
  public final static int MID_INDEX = 0;
  public final static int PROPERTY_INDEX = 1;
  public final static int LANGUAGE_INDEX = 2;
  public final static int VALUE_INDEX = 2;
  public final static int DATE_INDEX = 3;
  public final static int NAME_INDEX = 3;
