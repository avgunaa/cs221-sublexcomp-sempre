...
//import edu.stanford.nlp.sempre.fbalignment.lexicons.normalizers.BinaryNormalizer;

public class LinkedExtractionFileUtils {

  private String m_extractionFile;
  private final static int ARG1_INDEX = 0;
  private final static int PREDICATE_INDEX = 1;
  private final static int ARG2_INDEX = 2;
  private final static int MID_INDEX = 3;
  public final static Pattern DELIMITER_PATTERN = Pattern.compile("\t");
  public final static String TIME_ARG = "TIME:";


  public LinkedExtractionFileUtils(String extractionFileName) {
    m_extractionFile = extractionFileName;
  }
  ...
  public Map<String, Set<String>> getIdToExtractionsMap() throws IOException {
    ...
    BufferedReader reader = IOUtils.getBufferedFileReader(m_extractionFile);
    String line;
  ...
  public Map<String, Map<String, List<String>>> getIdToArg2ToPredicateListMap() throws IOException {
    ...
    for (String line : IOUtils.readLines(m_extractionFile)) {
