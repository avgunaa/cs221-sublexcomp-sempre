...
public class DatumGenerator {
  ...
  public final static int INTERSECTION_SIZE_INDEX = 5;
  public final static String INTERSECTION_FEATURE = "intersection";

  public final static int NL_TYPED_SIZE_INDEX = 6;
  public final static String NL_TYPED_SIZE_FEATURE = "nl_typed_size";

  public final static int FB_TYPED_SIZE_INDEX = 7;
  public final static String FB_TYPED_SIZE_FEATURE = "fb_typed_size";

  public final static int NL_SIZE_INDEX = 8;
  public final static String NL_SIZE_FEATURE = "nl_size";

  public final static int JACCARD_INDEX = 9;
  public final static String JACCARD_FEATURE = "jaccard";

  public final static String BIAS = "bias";

  public final static int LABLE_INDEX = 11;
