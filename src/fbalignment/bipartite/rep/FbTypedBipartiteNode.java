...
public class FbTypedBipartiteNode extends FbBipartiteNode {
  ...
  public FbTypedBipartiteNode(FbBipartiteNode fbNode) {
    ...
    for (int typeId : fbNode.m_arg2TypeIdToPairsMap.keySet()) {
