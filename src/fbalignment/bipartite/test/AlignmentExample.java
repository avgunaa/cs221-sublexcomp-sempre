...
public class AlignmentExample {
  ...
  protected final static int NL_DESC_INDEX = 0;
  protected final static int TYPE_1_INDEX = 1;
  protected final static int TYPE_2_INDEX = 2;
  protected final static int FB_DESC_INDEX = 3;
