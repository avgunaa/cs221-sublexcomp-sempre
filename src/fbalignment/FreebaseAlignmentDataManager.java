...
public class FreebaseAlignmentDataManager implements Serializable {
  ...
  public void genrateBigraph() throws IOException, NumberFormatException {
  ...
  public static class IdInfo implements Serializable {
    ...
    private Set<Integer> m_typeSet;

    public IdInfo(String id) {
      m_id = id;
      m_typeSet = new TreeSet<Integer>();
    ...
    public void addType(int typeId) {
      m_typeSet.add(typeId);
    }

    public String getMid() {return m_id; }
    public String getName() { return m_name; }
    public Set<Integer> getTypeSet() { return m_typeSet; }

    public String toString() {
      return m_id + "\t" + m_name + "\t" + m_typeSet;
    }
  }
}
