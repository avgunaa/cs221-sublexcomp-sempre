...
import edu.stanford.nlp.sempre.fbalignment.utils.FreebaseUtils;
import edu.stanford.nlp.sempre.fbalignment.utils.LinkedExtractionFileUtils;
...
public class FromPartiallyLinkedExtractionsGraphBuilder implements FbGraphBuilder<FbEntity, ShortContainer> {
  ...
  private LinkedExtractionFileUtils m_extractionUtils;
  private String m_datadumpFile;
  // private String m_mid2NameFile;
  private String m_propertyFile;


  public FromPartiallyLinkedExtractionsGraphBuilder(Properties props) {
    m_extractionUtils = new LinkedExtractionFileUtils(props.getProperty("extraction-file"));
    m_datadumpFile = props.getProperty("datadump-file");
    //  m_mid2NameFile = props.getProperty("mid-to-name-file");
    m_propertyFile = props.getProperty("property-file");

  }
  public FromPartiallyLinkedExtractionsGraphBuilder(String extractionFile, String datadumpFile, String propertyFile) {
    m_extractionUtils = new LinkedExtractionFileUtils(extractionFile);
    m_datadumpFile = datadumpFile;
    // m_mid2NameFile = mid2NameFile;
  ...
  public DirectedSparseMultigraph<FbEntity, ShortContainer> constructFbGraph() throws IOException {
    ...
    Map<String, String> mid2NameMap = FreebaseUtils.loadMid2NameMap(m_mid2NameFile);
    ...
    Set<String> extractionMids = m_extractionUtils.getLinkedIdSet();
    ...
    BiMap<Short, String> propertyMap = FreebaseUtils.loadProperties(m_propertyFile);
  ...
  private Set<String> addEdgesInGraphForMids(Set<String> currMids,
    ...
    BufferedReader reader = IOUtils.getBufferedFileReader(m_datadumpFile);
    String line;
    int i = 0;
  ...
  public static DirectedSparseMultigraph<FbEntity, ShortContainer> loadGraphFromFile(String graphFile) throws NumberFormatException, IOException {
