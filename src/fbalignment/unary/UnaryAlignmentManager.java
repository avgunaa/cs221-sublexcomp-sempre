...
//import edu.stanford.nlp.sempre.fbalignment.lexicons.normalizers.UnaryNormalizer;
...
public class UnaryAlignmentManager implements Runnable {
  ...
  private final static int CLASS_INDEX = 2;
  private final static int ID_INDEX = 3;
  private final static Set<String> unaries = ArrayUtils.asSet(new String[]{"fb:type.object.type", "fb:people.person.profession"});
