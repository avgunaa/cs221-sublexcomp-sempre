...
import edu.stanford.nlp.sempre.fbalignment.utils.FormatConverter;
...
public class UnaryTupleGenerator {
  ...
  private final static Pattern unaryPattern = Pattern.compile("(is|was) (a|the) (.+) (in|at|for|from|about|of|under|on|near|around)");
  private final static Pattern isAPattern = Pattern.compile("(is|was) (a|the) ");
  private final static Pattern prepositionPattern = Pattern.compile(" (in|at|for|from|about|of|under|on|near|around)");
